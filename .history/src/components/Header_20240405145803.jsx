...
function Header() {
  return (
    <Navbar fluid rounded className="bg-blue">
      <Navbar.Brand as={Link} href="/">
        <img src={"/src/assets/ricardo2.png"} alt="logo"  />
      </Navbar.Brand>
      <Navbar.Toggle />
      <Navbar.Collapse className="text-orange">
        <Navbar.Link href="/">
          Home
        </Navbar.Link>
        ...
        <Navbar.Link href="/empresa">Empresa</Navbar.Link>
        <Navbar.Link href="/contacto">Contactos</Navbar.Link>
      </Navbar.Collapse>
    </Navbar>
