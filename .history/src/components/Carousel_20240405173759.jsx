...
function MyCarousel() {
  return (
    <div className="h-96 sm:h-128 xl:h-1920 2xl:h-240">
      ...
      <div className="flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-or bg-[url('/src/assets/hero2.jpg' alt='image1' style={{ objectFit: 'contain' })]">
